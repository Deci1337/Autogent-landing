...
const AGENTS = [
  {
    ...
    t: 'ИИ-РОП',
    d: 'Следит за воронкой и каждый день присылает отчёт по работе менеджерам. Видит и слышит каждый диалог, считает конверсию, фиксирует узкие места и даёт обратную связь менеджерам.',
    result: 'РОП занимается стратегией, а не разбором полётов',
  },
  {
    k: 'Продажи и лиды',
    t: 'ИИ-продажник',
    d: 'Принимает заявки из Telegram, ВКонтакте, Авито и сайта 24/7. Консультирует, квалифицирует, отрабатывает возражения, оформляет заказ и передаёт готового клиента в CRM.',
    result: 'Ноль потерянных заявок, даже ночью и в выходные',
  },
  {
    k: 'Онбординг и ответы сотрудникам',
    t: 'ИИ-Онбординг',
  ...
  {
    k: 'Документооборот',
    t: 'ИИ-документооборот',
    d: 'Анализирует документы, помогает сотрудникам делать КП, ТЗ и договоры.',
    result: 'Для компаний, где частая рутина: работа с документами',
  },
];
