...
export default function Hero() {
  return (
    <section id="top" className="relative min-h-screen flex flex-col justify-center px-5 pt-24 pb-20 sm:px-8 sm:pt-28 sm:pb-24" style={{ background: '#000000', zIndex: 1 }}>
