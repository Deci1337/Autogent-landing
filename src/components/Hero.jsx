...
export default function Hero() {
  return (
    <section id="top" className="relative flex flex-col justify-center px-5 pt-24 pb-48 sm:px-8 sm:pt-28 sm:pb-56" style={{ background: '#000000', zIndex: 1, minHeight: '115vh' }}>
